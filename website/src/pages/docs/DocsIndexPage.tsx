      ...
      <div className="grid sm:grid-cols-2 gap-4 mb-16">
        {quickLinks.map((link, index) => (
          ...
          >
            <Link
              to={link.href}
              className="block gradient-border p-6 group hover:border-blue-500/30 transition"
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-500/20 flex items-center justify-center flex-shrink-0">
                  {link.icon}
                </div>
                <div>
